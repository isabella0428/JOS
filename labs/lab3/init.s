...
.LM12:
	...
	.cfi_def_cfa_offset 48
	call	cprintf
	.stabn	68,0,42,.LM13-.LFBB2
.LM13:
	movl	$6581362, 28(%esp)
	.stabn	68,0,43,.LM14-.LFBB2
.LM14:
	addl	$12, %esp
	.cfi_def_cfa_offset 36
	leal	16(%esp), %eax
...
.LM24:
	movl	%esi, panicstr
	.stabn	68,0,82,.LM25-.LFBB3
.LM25:
/APP
/  82 "kern/init.c" 1
	cli; cld
/  0 "" 2
	.stabn	68,0,84,.LM26-.LFBB3
.LM26:
/NO_APP
	leal	28(%esp), %ebx
	.stabn	68,0,85,.LM27-.LFBB3
.LM27:
	pushl	%eax
	.cfi_def_cfa_offset 20
	pushl	24(%esp)
...
.LFB3:
	...
	subl	$8, %esp
	.cfi_def_cfa_offset 16
	.stabn	68,0,102,.LM31-.LFBB4
.LM31:
	leal	28(%esp), %ebx
	.stabn	68,0,103,.LM32-.LFBB4
.LM32:
	pushl	%eax
	.cfi_def_cfa_offset 20
	pushl	24(%esp)
...
.LM33:
	...
	.cfi_def_cfa_offset 32
	call	vcprintf
	.stabn	68,0,105,.LM34-.LFBB4
.LM34:
	movl	$.LC11, (%esp)
	call	cprintf
	.stabn	68,0,107,.LM35-.LFBB4
.LM35:
	addl	$24, %esp
	.cfi_def_cfa_offset 8
	popl	%ebx
...
.Lscope4:
	...
	.comm	text_color,4,4
	.stabs	"text_color:G(0,1)",32,0,0,0
