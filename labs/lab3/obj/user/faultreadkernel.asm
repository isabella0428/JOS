	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f7:	0f be 80 49 0d 80 00 	movsbl 0x800d49(%eax),%eax
  8001fe:	50                   	push   %eax
...
00800245 <vprintfmt>:
{
  ...
  800290:	ff 24 85 d8 0d 80 00 	jmp    *0x800dd8(,%eax,4)
  ...
  80035a:	8b 04 85 30 0f 80 00 	mov    0x800f30(,%eax,4),%eax
  800361:	85 c0                	test   %eax,%eax
  800363:	74 1c                	je     800381 <vprintfmt+0x13c>
				printfmt(putch, putdat, "%s", p);
  800365:	50                   	push   %eax
  800366:	68 6a 0d 80 00       	push   $0x800d6a
  80036b:	53                   	push   %ebx
  80036c:	56                   	push   %esi
  ...
  800381:	52                   	push   %edx
  800382:	68 61 0d 80 00       	push   $0x800d61
  800387:	53                   	push   %ebx
  800388:	56                   	push   %esi
  ...
  8003c5:	eb 62                	jmp    800429 <vprintfmt+0x1e4>
				p = "(null)";
  8003c7:	c7 45 cc 5a 0d 80 00 	movl   $0x800d5a,-0x34(%ebp)
...
sys_env_destroy(envid_t envid)
{
  ...
  800a79:	68 4c 0f 80 00       	push   $0x800f4c
  800a7e:	6a 23                	push   $0x23
  800a80:	68 69 0f 80 00       	push   $0x800f69
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800ac5:	56                   	push   %esi
  800ac6:	50                   	push   %eax
  800ac7:	68 78 0f 80 00       	push   $0x800f78
  ...
  800ad8:	e8 25 f6 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  800add:	c7 04 24 9c 0f 80 00 	movl   $0x800f9c,(%esp)
