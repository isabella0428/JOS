	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001ce:	0f be 80 18 0d 80 00 	movsbl 0x800d18(%eax),%eax
  8001d5:	50                   	push   %eax
...
0080021c <vprintfmt>:
{
  ...
  800267:	ff 24 85 a8 0d 80 00 	jmp    *0x800da8(,%eax,4)
  ...
  800331:	8b 04 85 00 0f 80 00 	mov    0x800f00(,%eax,4),%eax
  800338:	85 c0                	test   %eax,%eax
  80033a:	74 1c                	je     800358 <vprintfmt+0x13c>
				printfmt(putch, putdat, "%s", p);
  80033c:	50                   	push   %eax
  80033d:	68 39 0d 80 00       	push   $0x800d39
  800342:	53                   	push   %ebx
  800343:	56                   	push   %esi
  ...
  800358:	52                   	push   %edx
  800359:	68 30 0d 80 00       	push   $0x800d30
  80035e:	53                   	push   %ebx
  80035f:	56                   	push   %esi
  ...
  80039c:	eb 62                	jmp    800400 <vprintfmt+0x1e4>
				p = "(null)";
  80039e:	c7 45 cc 29 0d 80 00 	movl   $0x800d29,-0x34(%ebp)
...
sys_env_destroy(envid_t envid)
{
  ...
  800a50:	68 1c 0f 80 00       	push   $0x800f1c
  800a55:	6a 23                	push   $0x23
  800a57:	68 39 0f 80 00       	push   $0x800f39
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800a9c:	56                   	push   %esi
  800a9d:	50                   	push   %eax
  800a9e:	68 48 0f 80 00       	push   $0x800f48
  ...
  800aaf:	e8 25 f6 ff ff       	call   8000d9 <vcprintf>
	cprintf("\n");
  800ab4:	c7 04 24 0c 0d 80 00 	movl   $0x800d0c,(%esp)
